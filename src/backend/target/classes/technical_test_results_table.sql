...
-- Stores results of technical assessments taken by candidates
...
CREATE TABLE technical_test_results (
    ...
    -- Section-wise details (if multiple sections exist)
...
INSERT INTO technical_test_results (
    ...
    1800, 
    TRUE,
    '{"technical": {"score": 15, "total": 20, "percentage": 75.00}}'
);

-- Verify table creation
SELECT * FROM technical_test_results;
